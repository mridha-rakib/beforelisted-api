...
export class RenterService {
  ...
  async registerRenter(
    ...
    const user = await this.userService.create({
      ...
      referredByRole: referrer?.role as ROLES.ADMIN | ROLES.AGENT | "direct",
    ...
    const { otp, expiresAt } = await this.emailVerificationService.createOTP(
      user._id.toString(),
      user.email
    );
