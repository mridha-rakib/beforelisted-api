...
export class RenterService {
  ...
  private async registerAdminReferralRenter(
    ...
    const temporaryPassword = AuthUtil.generateRandomPassword(16);
    ...
    const renterProfile = await this.repository.createRenter({
      ...
      emailVerified: true, // Auto-verified for admin referral
      accountStatus: "active", // Auto-activated for admin referral
    ...
    return {
      ...
      tokens,
      registrationType: "admin_referral",
      temporaryPassword, // Include in response (only in development!)
