...
export class PreMarketController {
  ...
  private async buildAgentRequestDetailsResponse(
    ...
    if (agent.hasGrantAccess) {
      ...
      const scopePresentation = await this.preMarketService.getScopePresentationForAgent(
        userId,
        request as any,
        matchRecord,
      );
      ...
      if (matchRecord) {
        ...
        return withOwnerRepresentationDetails({
          ...
          matchedRenterUpdatedAt: matchRecord.matchedRenterUpdatedAt ?? null,
      ...
      const responsePayload
        = await this.preMarketService.enrichOwnerRepresentationDetailsForAgent(
          ...
          request as any,
          {
            ...
            matchedRenterUpdatedAt: paidAccess.matchedRenterUpdatedAt ?? null,
            accessType: paidAccess.status,
            status: "matched",
            listingStatus: "matched",
          },
